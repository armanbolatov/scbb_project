...
for p in h5ads:
    ...
    micro = ad[ad.obs['cell_type_marker']=='excitatory_neuron']
    if micro.n_obs == 0:
        continue
...
pathway_names = [
    ...
    'regulation of trans-synaptic signaling (GO:0099177)',       # e.g. “signalling” vs “signaling”
    'cell–cell adhesion mediated by cadherin (GO:0044331)',           # maybe plural “processes”
...
def prerank_group_gsea_and_plot(counts_df, meta_df, geneset, gene_set_name,
    ...
    ax.plot(ES, color='#16C47F', lw=1.5)
...
for pname in pathway_names:
    ...
    prerank_group_gsea_and_plot(
        ...
        output_prefix = f"_excitatory_neurons/{pname}_GSEA_M_vs_F_{pname.replace(' ','_')}"
    )
...
for sex in ['Female','Male']:
    for pname in pathway_names:
        ...
        prerank_group_gsea_and_plot(
            ...
            output_prefix = f"_excitatory_neurons/{pname}_GSEA_{sex}_AD_vs_{sex}_Control_{pname.replace(' ','_')}"
        )