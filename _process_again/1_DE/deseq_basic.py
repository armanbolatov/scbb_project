...
def main():
    ...
    dds.deseq2()
    dds.fit_LFC(n_cpus=1)
    # 2) make your inference object _without_ passing dds
    inf = DefaultInference(n_cpus=1)

    # 3) specify your contrast (e.g. Disease vs Control)
    ...
    res.to_csv('/l/users/darya.taratynova/scbb_project/_process_again/pydeseq2_results.csv')
